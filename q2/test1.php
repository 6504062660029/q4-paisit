...
<html lang="en">
  ...
  <body>
    ...
    <article style="padding: 100px 160px 100px;">
        ...
        <!-- Radio buttons for selecting hospital size -->
        <label>
            <input type="radio" name="hospital-size" value="large" onclick="displayHospitals()"> โรงพยาบาลขนาดใหญ่
        </label>
        <label>
            <input type="radio" name="hospital-size" value="medium" onclick="displayHospitals()"> โรงพยาบาลขนาดกลาง
        </label>
        <label>
            <input type="radio" name="hospital-size" value="small" onclick="displayHospitals()"> โรงพยาบาลขนาดเล็ก
        </label>
        ...
        <script>
            ...
            function displayHospitals() {
                ...
                let selectedValue = document.querySelector('input[name="hospital-size"]:checked').value;
